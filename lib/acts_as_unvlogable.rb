# Included gems
require 'youtube_g'
require 'lib/acts_as_unvlogable/flickr'
# Extensions
if defined?(ActiveSupport).nil?
  require 'lib/acts_as_unvlogable/string_base'
  require 'lib/acts_as_unvlogable/object_base'
end
require 'lib/acts_as_unvlogable/string_extend'
